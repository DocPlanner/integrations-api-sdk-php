...
class CalendarsApi
{
     ...
     * @throws \DocPlanner\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DocPlanner\Client\Model\Calendar
     */
    public function getCalendar($facility_id, $doctor_id, $address_id)
    {
        list($response) = $this->getCalendarWithHttpInfo($facility_id, $doctor_id, $address_id);
        return $response;
    }
     ...
     * @throws \DocPlanner\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DocPlanner\Client\Model\Calendar, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCalendarWithHttpInfo($facility_id, $doctor_id, $address_id)
    {
        $returnType = '\DocPlanner\Client\Model\Calendar';
        $request = $this->getCalendarRequest($facility_id, $doctor_id, $address_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocPlanner\Client\Model\Calendar',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCalendarAsync($facility_id, $doctor_id, $address_id)
    {
        return $this->getCalendarAsyncWithHttpInfo($facility_id, $doctor_id, $address_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCalendarAsyncWithHttpInfo($facility_id, $doctor_id, $address_id)
    {
        $returnType = '\DocPlanner\Client\Model\Calendar';
        $request = $this->getCalendarRequest($facility_id, $doctor_id, $address_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCalendarRequest($facility_id, $doctor_id, $address_id)
    {
        // verify the required parameter 'facility_id' is set
        if ($facility_id === null || (is_array($facility_id) && count($facility_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $facility_id when calling getCalendar'
            );
        }
        // verify the required parameter 'doctor_id' is set
        if ($doctor_id === null || (is_array($doctor_id) && count($doctor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $doctor_id when calling getCalendar'
            );
        }
        // verify the required parameter 'address_id' is set
        if ($address_id === null || (is_array($address_id) && count($address_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address_id when calling getCalendar'
            );
        }

        $resourcePath = '/facilities/{facility_id}/doctors/{doctor_id}/addresses/{address_id}/calendar';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
