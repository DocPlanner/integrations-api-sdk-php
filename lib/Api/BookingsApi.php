...
class BookingsApi
{
     ...
     *
     * @param  \DocPlanner\Client\Model\ConfirmBookingRequest $body body (required)
     * @param  string $facility_id ID of the Facility (required)
     * @param  string $doctor_id ID of a doctor in a facility (required)
     * @param  string $address_id ID of a doctor&#x60;s address in a facility (required)
     * @param  string $booking_id ID of the Booking (required)
     ...
     * @return void
     */
    public function confirmBooking($body, $facility_id, $doctor_id, $address_id, $booking_id)
    {
        $this->confirmBookingWithHttpInfo($body, $facility_id, $doctor_id, $address_id, $booking_id);
    }

    /**
     * Operation confirmBookingWithHttpInfo
     *
     * @param  \DocPlanner\Client\Model\ConfirmBookingRequest $body (required)
     * @param  string $facility_id ID of the Facility (required)
     * @param  string $doctor_id ID of a doctor in a facility (required)
     * @param  string $address_id ID of a doctor&#x60;s address in a facility (required)
     * @param  string $booking_id ID of the Booking (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmBookingWithHttpInfo($body, $facility_id, $doctor_id, $address_id, $booking_id)
    {
        $returnType = '';
        $request = $this->confirmBookingRequest($body, $facility_id, $doctor_id, $address_id, $booking_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmBookingAsync($body, $facility_id, $doctor_id, $address_id, $booking_id)
    {
        return $this->confirmBookingAsyncWithHttpInfo($body, $facility_id, $doctor_id, $address_id, $booking_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation confirmBookingAsyncWithHttpInfo
     *
     * 
     *
     * @param  \DocPlanner\Client\Model\ConfirmBookingRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmBookingAsyncWithHttpInfo($body, $facility_id, $doctor_id, $address_id, $booking_id)
    {
        $returnType = '';
        $request = $this->confirmBookingRequest($body, $facility_id, $doctor_id, $address_id, $booking_id);
    ...
    /**
     * Create request for operation 'confirmBooking'
     *
     * @param  \DocPlanner\Client\Model\ConfirmBookingRequest $body (required)
     * @param  string $facility_id ID of the Facility (required)
     * @param  string $doctor_id ID of a doctor in a facility (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function confirmBookingRequest($body, $facility_id, $doctor_id, $address_id, $booking_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling confirmBooking'
            );
        }
        // verify the required parameter 'facility_id' is set
        if ($facility_id === null || (is_array($facility_id) && count($facility_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $facility_id when calling confirmBooking'
            );
        }
        // verify the required parameter 'doctor_id' is set
        if ($doctor_id === null || (is_array($doctor_id) && count($doctor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $doctor_id when calling confirmBooking'
            );
        }
        // verify the required parameter 'address_id' is set
        if ($address_id === null || (is_array($address_id) && count($address_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address_id when calling confirmBooking'
            );
        }
        // verify the required parameter 'booking_id' is set
        if ($booking_id === null || (is_array($booking_id) && count($booking_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $booking_id when calling confirmBooking'
            );
        }

        $resourcePath = '/facilities/{facility_id}/doctors/{doctor_id}/addresses/{address_id}/bookings/{booking_id}/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
