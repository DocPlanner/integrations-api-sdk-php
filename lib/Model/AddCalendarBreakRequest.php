...
'till' => '\DateTime',
'description' => 'string',
'apply_on_coupled_addresses' => 'bool'    ];
...
'till' => 'date-time',
'description' => null,
'apply_on_coupled_addresses' => null    ];
...
'apply_on_coupled_addresses' => 'apply_on_coupled_addresses'    ];
...
'apply_on_coupled_addresses' => 'setApplyOnCoupledAddresses'    ];
...
'apply_on_coupled_addresses' => 'getApplyOnCoupledAddresses'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['apply_on_coupled_addresses'] = isset($data['apply_on_coupled_addresses']) ? $data['apply_on_coupled_addresses'] : false;
    }
    ...
    /**
     * Gets apply_on_coupled_addresses
     *
     * @return bool
     */
    public function getApplyOnCoupledAddresses()
    {
        return $this->container['apply_on_coupled_addresses'];
    }

    /**
     * Sets apply_on_coupled_addresses
     *
     * @param bool $apply_on_coupled_addresses When true, the same break is also created on the coupled addresses of this doctor in this facility - the online-only ones for an offline address and the other way round. Those breaks are moved and removed together with this one. The response describes only the break created on the requested address.
     *
     * @return $this
     */
    public function setApplyOnCoupledAddresses($apply_on_coupled_addresses)
    {
        $this->container['apply_on_coupled_addresses'] = $apply_on_coupled_addresses;
