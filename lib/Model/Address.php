...
'insurance_support' => 'getInsuranceSupport'    ];
    ...
    const COMMERCIAL_TYPE_PREMIUM = 'premium';
const COMMERCIAL_TYPE_SAAS_ONLY = 'saas-only';
const COMMERCIAL_TYPE_BASIC = 'basic';
...
const INSURANCE_SUPPORT_PRIVATE_AND_INSURANCE = 'private_and_insurance';
     ...
     * @return string[]
     */
    public function getCommercialTypeAllowableValues()
    {
        return [
            self::COMMERCIAL_TYPE_PREMIUM,
self::COMMERCIAL_TYPE_SAAS_ONLY,
self::COMMERCIAL_TYPE_BASIC,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::INSURANCE_SUPPORT_PRIVATE_AND_INSURANCE,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['commercial_type'] = isset($data['commercial_type']) ? $data['commercial_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCommercialTypeAllowableValues();
        if (!is_null($this->container['commercial_type']) && !in_array($this->container['commercial_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'commercial_type', must be one of '%s'",
     ...
     *
     * @param string $commercial_type commercial_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCommercialTypeAllowableValues();
        if (!is_null($commercial_type) && !in_array($commercial_type, $allowedValues, true)) {
