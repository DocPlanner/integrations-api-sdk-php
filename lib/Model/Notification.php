...
const NAME_BOOKING_CONFIRMED = 'booking-confirmed';
...
const NAME_ADDRESS_SERVICE_CREATED = 'address-service-created';
const NAME_ADDRESS_SERVICE_DELETED = 'address-service-deleted';
const NAME_ADDRESS_SERVICE_CHANGED = 'address-service-changed';
const NAME_ADDRESS_COMMERCIAL_TYPE_CHANGED = 'address-commercial-type-changed';
...
self::NAME_BOOKING_CONFIRMED,
self::NAME_BREAK_CREATED,
self::NAME_BREAK_MOVED,
self::NAME_BREAK_REMOVED,
self::NAME_PRESENCE_MARKED,
self::NAME_ADDRESS_SERVICE_CREATED,
self::NAME_ADDRESS_SERVICE_DELETED,
self::NAME_ADDRESS_SERVICE_CHANGED,
self::NAME_ADDRESS_COMMERCIAL_TYPE_CHANGED,        ];
    }
